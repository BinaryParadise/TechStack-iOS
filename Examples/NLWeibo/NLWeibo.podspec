#
# Be sure to run `pod lib lint NLWeibo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'NLWeibo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of NLWeibo.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rakeyang/NLWeibo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rakeyang' => 'fenglaijun@gmail.com' }
  s.source           = { :git => 'https://github.com/rakeyang/NLWeibo.git', :tag => s.version.to_s }
