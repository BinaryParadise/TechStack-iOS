...
#import "NLTIRouterAction.h"
#import "NLTIRouterUIHelper.h"

@interface NLTIRouterActionVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation NLTIRouterActionVC
...
+ (NSBundle *)routerActionBundle {
    return [NSBundle bundleWithURL:[[NSBundle mainBundle].bundleURL URLByAppendingPathComponent:@"NLTIRouterAction.bundle"]];
}
...
//    }
    [self.tableView registerClass:[NLTIRouterActionCell class] forCellReuseIdentifier:@"NLTIRouterActionCell"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NLTIRouterActionCell *cell = [self.tableView dequeueReusableCellWithIdentifier:@"NLTIRouterActionCell" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!node.config) {
        NLTIRouterActionVC *nodeVC = [[NLTIRouterActionVC alloc] init];
